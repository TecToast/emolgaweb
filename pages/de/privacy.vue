...
<template>
  <div class="text-left text-gray-400 mx-auto max-w-6xl my-10 text-lg">
    ...
    <ul class="list-disc">
      ...
      <li>Kanal-IDs</li>
      <li>Benutzer-IDs</li>
      <li>Benutzernamen (nur um diese ohne Ping zu erwähnen oder auf dieser Website zum Anzeigen)</li>
      <li>Benutzeravatarurls (um das Profilbild hier anzuzeigen)</li>
      <li>Rollen-IDs</li>
      <li>Den "Pokémon Showdown!" Account-Namen (nur wenn man ihn explizit angibt)</li>
    </ul>
    <br>
    ...
    <br>
    <h3 class="text-3xl text-gray-200 mt-4 mb-2">Wie werden die Daten verwendet?</h3>
    Diese Daten werden für die Funktionalität des Discord-Bots und dieser Website benötigt. Es erfolgt keine Weitergabe
    an dritte Parteien.<br>
    <br>
    Für das Löschen Ihrer Daten können Sie mich über Discord (<code>{{ MY_DISCORD_TAG }}</code>) oder per E-Mail
    erreichen:
    <NuxtLink
        to="mailto:flo@tectoast.de" class="underline">flo@tectoast.de
    </NuxtLink>
    <br>
